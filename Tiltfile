...
k8s_resource('server', port_forwards=[8980,9092], labels="buildfarm-cluster", trigger_mode=TRIGGER_MODE_MANUAL)
k8s_resource('shard-worker', port_forwards=[8981,9091], labels="buildfarm-cluster", trigger_mode=TRIGGER_MODE_MANUAL)
k8s_resource('redis-cluster', port_forwards=6379, labels="buildfarm-cluster", trigger_mode=TRIGGER_MODE_MANUAL)
