...
k8s_resource('server', port_forwards=8980, labels="buildfarm-cluster", trigger_mode=TRIGGER_MODE_MANUAL)
k8s_resource('shard-worker', port_forwards=8981, labels="buildfarm-cluster", trigger_mode=TRIGGER_MODE_MANUAL)
