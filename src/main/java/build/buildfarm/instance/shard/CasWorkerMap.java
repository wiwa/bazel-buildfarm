...
public interface CasWorkerMap {
   ...
   */
  void add(JedisClient client, Digest blobDigest, String workerName) throws IOException;
   ...
   */
  void addAll(JedisClient client, Iterable<Digest> blobDigests, String workerName)
      throws IOException;
   ...
   */
  void remove(JedisClient client, Digest blobDigest, String workerName) throws IOException;
   ...
   * @param workerName The worker name to remove.
   */
  void removeAll(JedisClient client, Iterable<Digest> blobDigests, String workerName)
      throws IOException;
   ...
   */
  String getAny(JedisClient client, Digest blobDigest) throws IOException;
   ...
   */
  Set<String> get(JedisClient client, Digest blobDigest) throws IOException;
   ...
   */
  Map<Digest, Set<String>> getMap(JedisClient client, Iterable<Digest> blobDigests)
      throws IOException;
   ...
   */
  int size(JedisClient client) throws IOException;
}
