...
public class ExampleWorkerProcess {
  ...
  public static void main(String[] args) throws Exception {
    //System.out.println("ExampleWorkerProcess: " + String.join(",", Arrays.asList(args)));
...
//      persistentWorkerMain();
  ...
  static void jbMain(String[] args) {
    ...
    // System.out.println("ExampleWorkerRequest --persistent_worker started with args: " + String.join(",", args));
