...
/**
 * Why does an ObjectFactory do more than factor (lol) the object?
 *
 ...
 */
public abstract class Supervisor<K, V extends Destructable> extends BaseKeyedPooledObjectFactory<K, V> {
